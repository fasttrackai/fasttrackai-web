  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12">
      <div className="container mx-auto px-4">
        {/* Header - Enhanced Title */}
        <div className="mb-10 flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-200 pb-6">
          <div className="flex items-center">
             <LayoutDashboard className="h-8 w-8 mr-3 text-purple-600" /> 
          ...
          <div className="mt-4 md:mt-0 flex items-center space-x-4">
             ...
             {usedMockData && (
               <span className={`text-sm inline-flex items-center bg-amber-100 text-amber-800 font-medium px-3 py-1 rounded-full shadow-sm'`}>
                  <Info className="h-4 w-4 mr-1.5" /> Viewing sample data
               </span>
             )}
            <button 
              className="button-primary inline-flex items-center" // Themed button
        ...
        {/* Keep the subtitle separate if needed, or remove if title is enough 
        <p className={`text-sm mb-8 ${usedMockData ? 'hidden' : 'text-gray-600'}`}>
