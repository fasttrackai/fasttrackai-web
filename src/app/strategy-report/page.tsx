...
export default function StrategyReport() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if the response is a fallback (API keys not available)
      if (result.fallback) {
        console.log('API keys not available - redirecting to consultation page');
        // Redirect to consultation scheduling page instead of showing analysis
