          ...
          <AnimatePresence>
            {showWelcomeText && !hideWelcomeText && (
              ...
              >
                ...
                >
                  Welcome to <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-indigo-200">fasttrack</span><span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-300 to-yellow-400" style={{ filter: 'drop-shadow(0 0 6px rgba(251, 191, 36, 0.4))' }}>ai</span>
                </motion.h1>
                <motion.p 
